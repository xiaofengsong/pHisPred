...
def Moran(fastas, props=['CIDH920105', 'BHAR880101', 'CHAM820101', 'CHAM820102',
	...
	fileAAidx = re.sub('codes$', '', os.path.split(os.path.realpath(__file__))[0]) + r'\codes\data\AAidx.txt' if platform.system() == 'Windows' else sys.path[0] + '/codes/data/AAidx.txt'
